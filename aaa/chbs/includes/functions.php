		      ...
		      <div class="collapse navbar-collapse" id="navbarsExampleDefault">
		        <ul class="navbar-nav mr-auto">
		          ...
		          <li class="nav-item dropdown">
		            <a class="nav-link dropdown-toggle" href="view_client.php" id="dropdown01" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> PATIENT DETAILS</a>
		            <div class="dropdown-menu" aria-labelledby="dropdown01">
		              <a class="dropdown-item" href="add_client.php"><i class="fa fa-plus"></i> Add PATIENT</a>
		              <a class="dropdown-item" href="view_client.php"><i class="fa fa-eye"></i> View Add PATIENT</a>
		              <a class="dropdown-item" href="edit_client.php"><i class="fa fa-edit"></i> Edit Add PATIENT</a>
		            </div>
		          </li>
				  <ul class="navbar-nav mr-auto">
		          <li class="nav-item ">
		            <a class="nav-link" href="../index1.php">LOGOUT <span class=""></span></a>
		          </li>
