	...
	<div class="container">
		<div class="row">
			<h2 class="section-title">
				<span class="bold700">LOGIN</span>
			</h2>
			<!-- <p class="section-subtitle">Our Clinic has grown to provide a world class facility for the treatment of tooth loss, dental cosmetics and advanced restorative dentistry.</p> -->
			<!-- <h2>login</h2> -->



			<form action="ad.php" method="post" autocomplete="" id="">
